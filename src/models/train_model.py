...
df_train = df.drop(["participant", "category", "set", "duration"], axis=1) # Drop non-feature columns

X = df_train.drop("label", axis=1) # Feature Matrix
y = df_train["label"] # Target variable

X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=0.25, random_state=42, stratify=y) # 75% training and 25% test
